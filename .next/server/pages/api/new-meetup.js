...
async function handler(req, res) {
    if (req.method === "POST") {
        const data = req.body;
        const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://mahujedin:7f4wasz123@cluster0.ebgxm.mongodb.net/meetups?retryWrites=true&w=majority");
        const db = client.db();
